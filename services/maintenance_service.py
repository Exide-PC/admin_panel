...
class MaintenanceService:
    __commands = [
        ...
        MaintenanceCommand('dc45bbd3-1676-48da-9777-448232de7d41', 'Restart bot manager', 'Bot Exide [Prod]', 'docker compose -f /home/exide/repos/bot_exide/compose.yaml --env-file /home/exide/repos/bot_exide/.env.docker.prod restart telegram_bot_manager'),
